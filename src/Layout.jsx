  ...
  return (
    <span className="logo-mark" aria-hidden="true">
      <svg viewBox="0 0 24 24" fill="none">
        <path
          d="M12 2c2.2 2.2 3.3 4.4 3.3 6.6 0 1.8-1.5 3.3-3.3 3.3S8.7 10.4 8.7 8.6c0-2.2 1.1-4.4 3.3-6.6Z"
          fill="currentColor"
        />
        <path
          d="M5 14c1.5-1 3-1.4 4.5-1.4 1.2 0 2 .35 2.5.8.5-.45 1.3-.8 2.5-.8 1.5 0 3 .4 4.5 1.4 1.3.9 2 2.1 2 3.3 0 1.3-.8 2.6-2.4 3.4-1.6.8-3.8 1.3-6.6 1.3s-5-.5-6.6-1.3C3.8 19.9 3 18.6 3 17.3 3 16.1 3.7 14.9 5 14Z"
          fill="currentColor"
          opacity=".85"
        />
      </svg>
